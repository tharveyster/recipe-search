...
router.get("/search/recipe", (req, res) => {
  axios({
    baseURL: "",
    url: `https://api.spoonacular.com/recipes/complexSearch?apiKey=ac30df0b79dd4751ae614db60f23c6a2&query=${encodeURIComponent(
      req.query.search
    )}&number=10`,
    method: "GET",
  })
...
router.get("/search/ingredient", (req, res) => {
  axios({
    baseURL: "",
    url: `https://api.spoonacular.com/recipes/findByIngredients?apiKey=ac30df0b79dd4751ae614db60f23c6a2&number=10&ingredients=${req.query.search}`,
    method: "GET",
  })
    .then((response) => {
